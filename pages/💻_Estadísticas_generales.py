...
# Sección principal para mostrar los datos filtrados y las visualizaciones
...
fig_año = px.bar(conteo_por_año, x='Anio', y='NumeroCasos', title='Tendencia Anual de Suicidios',color_discrete_sequence=['#E74C3C', '#E74C3C', '#E74C3C', ])
...
fig_region = px.bar(conteo_por_region, x='NombreRegion', y='NumeroCasos', title='Total de Suicidios por Región', color_discrete_sequence=['#3508DB', '#E74C3C', '#E74C3C', ] )
